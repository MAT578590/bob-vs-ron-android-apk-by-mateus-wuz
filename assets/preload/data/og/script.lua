...
IntroTagWidth = 15
Name = '  OG'
Author = '   AadstaPinwheel'
FanAuthor = 'SeanLeTroll'
FanAuthorOn = true

function onUpdate()
setProperty('Gay2.alpha', 0.4)
end

function onCreate()

	makeLuaSprite('Gay2', 'Gay2', -375-IntroTagWidth, 35)
	makeGraphic('Gay2', 370, 100, '999999')
	setObjectCamera('Gay2', 'other')
	addLuaSprite('Gay2', true)
	
	makeLuaText('JukeBoxText', 'Jogando Agora:', 300, -305-IntroTagWidth, 40)
	...
	makeLuaText('JukeBoxText2', 'Compositor:', 300, -305-IntroTagWidth, 70)
	...
	makeLuaText('JukeBoxText3', 'Cover:', 300, -305-IntroTagWidth, 100)
...
function onSongStart()
	...
	doTweenX('MoveInTwo', 'Gay2', 0, 1, 'CircInOut')
...
function onTimerCompleted(tag, loops, loopsLeft)
	if tag == 'JukeBoxWait' then
		...
		doTweenX('MoveOutTwo', 'Gay2', -520, 1.5, 'CircInOut')
